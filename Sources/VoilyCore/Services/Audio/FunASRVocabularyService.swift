...
struct FunASRVocabularyEntry: Codable, Equatable, Sendable {
    let text: String
    let weight: Int
}

struct FunASRVocabularySyncPlan: Equatable, Sendable {
...
enum FunASRVocabularyServiceError: LocalizedError, Sendable {
    case missingBaseURL
    case missingAPIKey
    case missingModel
...
public actor FunASRVocabularyService {
    ...
    public func syncVocabularyIfNeeded(config: ASRProviderConfig, glossaryTerms: [String]) async throws -> ASRProviderConfig {
