...
public struct FunASRRealtimeASRResult: Equatable, Sendable {
    public let text: String
    public let duration: TimeInterval
    public let commandSummary: String
}

enum FunASRRealtimeServiceError: LocalizedError, Sendable {
    case missingBaseURL
    case missingAPIKey
    case missingModel
...
public actor FunASRRealtimeService {
    private static let defaultMaxSentenceSilence = 1_300

    struct SentenceUpdate: Equatable, Sendable {
        let text: String
    ...
    public func testConnection(config: ASRProviderConfig, languageCode: String) async throws {
    ...
    public func appendAudioChunk(_ pcm16MonoData: Data) async throws {
    ...
    public func finishSession() async throws -> FunASRRealtimeASRResult {
        guard let webSocketTask else {
            throw FunASRRealtimeServiceError.sessionNotStarted
        }
    ...
    public static func normalizedSingleLineValue(_ value: String) -> String {
        value
